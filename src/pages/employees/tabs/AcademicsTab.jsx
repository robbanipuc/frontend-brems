...
import { Badge, EmptyState, Button } from '@/components/common';
...
const AcademicsTab = ({ employee }) => {
  ...
  return (
    <div className="p-6">
      <h3 className="text-lg font-semibold text-gray-900 mb-6">Academic Qualifications</h3>
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">{record.exam_name}</h4>
            ...
            <div className="mt-3 flex items-center justify-between">
              <div className="text-sm">
                ...
                <span className="font-medium text-gray-900">{record.result}</span>
              </div>
              
              {record.certificate_path && (
                <a
                  href={`/storage/${record.certificate_path}`}
                  target="_blank"
